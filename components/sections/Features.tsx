...
export function Features() {
    return (
        <section id="features" className="container space-y-6 bg-gradient-to-b from-slate-50 to-white py-8 dark:from-slate-950 dark:to-slate-900 md:py-12 lg:py-24 px-4 md:px-6 mx-auto">
            ...
            <div className="mx-auto grid justify-center gap-6 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                {courseFeatures.map((feature, index) => (
                    <Card 
                        key={feature.title} 
                        className="card-hover flex flex-col justify-between overflow-hidden border-2"
